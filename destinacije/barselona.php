...
<body>
    ...
    $upit = "SELECT sifra_kataloga, hotel.naziv_hotela, hotel.grad, datum_polaska, datum_dolaska, cena
            ...
            WHERE sifra_kataloga NOT IN (SELECT sifra_kataloga
                                        FROM rezervacija) AND hotel.grad = 'BARSELONA';";
    ...
    if (mysqli_num_rows($rezultat) > 0) {
        ...
        while ($row = mysqli_fetch_array($rezultat)) {
            ...
            echo "<td>$cena</td>";
            echo "<td>";
            echo "<form action='barselona.php' method='post'>";
        ...
        echo "Nema dostupnih ponuda za Barselonu!";
    }
    ...
    if (isset($_SESSION['JMBG']) && isset($_POST['sifra_kataloga'])) {
        ...
        if ($rezultat_rezervacija) {
            ...
            echo "<script>window.location.href = 'barselona.php?message=success'</script>";
        } else {
